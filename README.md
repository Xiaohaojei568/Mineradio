...
https://gitee.com/xiao-majie/mineradio/releases/tag/v1.1.0

GitHub Release 备用地址：

https://github.com/Xiaohaojei568/Mineradio/releases/tag/v1.1.0
...
该命令会先构建渲染端，再以 Electron 主进程调试端口 `9229` 启动桌面端，并自动打开窗口 DevTools。
...
```text
https://gitee.com/xiao-majie/mineradio/releases/download/v1.1.0/latest.yml
```
